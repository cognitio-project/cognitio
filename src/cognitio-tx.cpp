...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cognitio Core cognitio-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cognitio-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cognitio transaction") + "\n" +
                               "  cognitio-tx [options] -create [commands]   " + _("Create hex-encoded cognitio transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cognitio transaction
