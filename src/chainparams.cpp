...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Cognitio: 1 minute
        nTargetSpacing = 1 * 60;  // Cognitio: 1 minute
        nMaturity = 101;
...
public:
    CTestNetParams()
    {
        ...
        nDefaultPort = 51474;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Cognitio: 1 day
        nTargetSpacing = 1 * 60;  // Cognitio: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        // Testnet cognitio BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet cognitio BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet cognitio BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Cognitio: 1 day
        nTargetSpacing = 1 * 60;        // Cognitio: 1 minutes
