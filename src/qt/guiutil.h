...
/** Utility functions used by the Cognitio Qt UI.
 */
namespace GUIUtil
{
...
// Render Cognitio addresses in monospace font
...
// Parse "cognitio:" URI into recipient object, return true on successful parsing
