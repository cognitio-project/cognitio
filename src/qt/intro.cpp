...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cognitio Core"),
     ...
     * override -datadir in the cognitio.conf file in the default data directory
     * (to be consistent with cognitiod behavior)
     */
    if (dataDir != getDefaultDataDirectory())
