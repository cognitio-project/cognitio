...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Cognitio server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Cognitio server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cognitio features */
        {"cognitio", "masternode", &masternode, true, true, false},
        {"cognitio", "listmasternodes", &listmasternodes, true, true, false},
        {"cognitio", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cognitio", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cognitio", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cognitio", "masternodedebug", &masternodedebug, true, true, false},
        {"cognitio", "startmasternode", &startmasternode, true, true, false},
        {"cognitio", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cognitio", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cognitio", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cognitio", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cognitio", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cognitio", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cognitio", "mnbudget", &mnbudget, true, true, false},
        {"cognitio", "preparebudget", &preparebudget, true, true, false},
        {"cognitio", "submitbudget", &submitbudget, true, true, false},
        {"cognitio", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cognitio", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cognitio", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cognitio", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cognitio", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cognitio", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cognitio", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cognitio", "checkbudgets", &checkbudgets, true, true, false},
        {"cognitio", "mnsync", &mnsync, true, true, false},
        {"cognitio", "spork", &spork, true, true, false},
        {"cognitio", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cognitio", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cognitiod, or the -server option to cognitio-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cognitio-cli " + methodname + " " + args + "\n";
}
