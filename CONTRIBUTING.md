Contributing to Cognitio Core
============================

The Cognitio Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cognitio Core project, and is not to be
confused with overall Cognitio Network Protocol consensus changes.

Whether a pull request is merged into Cognitio Core rests with the project merge
...
Patches that change Cognitio consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cognitio consensus, it must have been
...
The project leader is the release manager for each Cognitio Core release.
