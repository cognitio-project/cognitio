...
RESOURCES += src/qt/cognitio.qrc src/qt/cognitio_locale.qrc

TRANSLATIONS += src/qt/locale/cognitio_bg.ts \
                src/qt/locale/cognitio_de.ts \
                src/qt/locale/cognitio_en.ts \
                src/qt/locale/cognitio_es.ts \
                src/qt/locale/cognitio_fi.ts \
                src/qt/locale/cognitio_fr.ts \
                src/qt/locale/cognitio_it.ts \
                src/qt/locale/cognitio_ja.ts \
                src/qt/locale/cognitio_pl.ts \
                src/qt/locale/cognitio_pt.ts \
                src/qt/locale/cognitio_ru.ts \
                src/qt/locale/cognitio_sk.ts \
                src/qt/locale/cognitio_sv.ts \
                src/qt/locale/cognitio_vi.ts \
                src/qt/locale/cognitio_zh_CN.ts \
                src/qt/locale/cognitio_zh_TW.ts
