...
This means one can have an always-on cognitiod instance running, and another local cognitiod/cognitio-qt instance which connects to this node and receives blocks from it.
