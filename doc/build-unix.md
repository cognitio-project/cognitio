UNIX BUILD NOTES
====================
Some notes on how to build Cognitio in Unix.

Note
---------------------
Always use absolute paths to configure and compile cognitio and the dependencies,
...
This will build cognitio-qt as well if the dependencies are met.
...
memory available when compiling Cognitio Core. With 512MB of memory or less
...
Notes
-----
The release is built with GCC and then "strip cognitiod" to strip the debug
