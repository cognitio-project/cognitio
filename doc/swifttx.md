...
This mechanism has been integrated into Bitcore-Node-Cognitio which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Cognitio-Project/insight-api-cognitio#web-socket-api](https://github.com/Cognitio-Project/insight-api-cognitio#web-socket-api) 
* API: [https://github.com/Cognitio-Project/insight-api-cognitio#swifttx-transactions](https://github.com/Cognitio-Project/insight-api-cognitio#swifttx-transactions) 
...
By default, the Cognitio Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Cognitio Core daemon:
