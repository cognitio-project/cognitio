...
In order to support loading of multiple wallets in cognitio-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cognitio.cpp.
...
Changes to cognitio.cpp
----------------------
cognitio.cpp is the entry point into cognitio-qt, and as such, will require some minor modifications to provide hooks for
